...
class ViewController: UIViewController {
    ...
    func layoutFrames() {
        ...
        view15.alignBetweenVertical(.underMatchingLeft, primaryView: view9, secondaryView: view14, padding: 10, width: 50)
        view16.alignBetweenHorizontal(.toTheRightMatchingBottom, primaryView: view14, secondaryView: view6, padding: 10, height: 40)
        view17.alignBetweenHorizontal(.toTheRightMatchingTop, primaryView: view15, secondaryView: anchorView, padding: 10, height: 100)
        view18.alignBetweenVertical(.underMatchingLeft, primaryView: anchorView, secondaryView: view16, padding: 10, width: anchorView.width)
        view19.alignBetweenHorizontal(.toTheRightMatchingTop, primaryView: view14, secondaryView: view18, padding: 10, height: 50)
        view20.alignBetweenVertical(.underCentered, primaryView: view17, secondaryView: view19, padding: 10, width: view17.width)
    }
